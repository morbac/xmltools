...
BOOL COptionsDlg::OnInitDialog() {
  ...
  pTmpOption = new CMFCPropertyGridProperty(L"Allow document function", (xmltoolsoptions.allowDocumentFunction > 0 ? L"True" : (xmltoolsoptions.allowDocumentFunction == 0 ? L"False" : L"Default")), L"Enables (true) or disables (false) the document function in XLST. Attempts to call the disabled document function will result in an \"Access Denied\" error.\r\nFor more information, see MSXML Security Overview (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms754611%28v%3dvs.85%29) and DOM Security (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms761392%28v%3dvs.85%29).", (DWORD_PTR)&xmltoolsoptions.allowDocumentFunction);
  ...
  pTmpOption = new CMFCPropertyGridProperty(L"Allow Xslt script", (xmltoolsoptions.allowXsltScript > 0 ? L"True" : (xmltoolsoptions.allowXsltScript == 0 ? L"False" : L"Default")), L"Enables (true) or disables (false) the <msxsl:script> element functionality in XLST. If this property is set to false, attempts to use a stylesheet that uses script will result in a \"Security settings do not allow the execution of script code within this stylesheet\" error.\r\n For more information, see MSXML Security Overview (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms754611%28v%3dvs.85%29) and DOM Security (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms761392%28v%3dvs.85%29).", (DWORD_PTR)&xmltoolsoptions.allowXsltScript);
  pTmpOption->AddOption(L"Default"); pTmpOption->AddOption(L"True"); pTmpOption->AddOption(L"False"); pTmpOption->AllowEdit(FALSE);
  pGrpXmlFeatures->AddSubItem(pTmpOption); vTristateProperties.push_back(pTmpOption);
  pTmpOption = new CMFCPropertyGridProperty(L"Force resync", (xmltoolsoptions.forceResync > 0 ? L"True" : (xmltoolsoptions.forceResync == 0 ? L"False" : L"Default")), L"When you load and parse an XML document from a URL that is not local (i.e. is on a different web site), that document may be cached by any number of servers on the line. If you are parsing an XML document that changes often, and it is important that your parser always retrieves the latest version of the document, you can set this property to true. When you set this property to true, it causes the XML document to not be cached; instead it is retrieved from its source server each time that you reparse the document.\r\nThis property is supported in MSXML 3.0 and 6.0. The default value is true.", (DWORD_PTR)&xmltoolsoptions.forceResync);
  pTmpOption->AddOption(L"Default"); pTmpOption->AddOption(L"True"); pTmpOption->AddOption(L"False"); pTmpOption->AllowEdit(FALSE);
  pGrpXmlFeatures->AddSubItem(pTmpOption); vTristateProperties.push_back(pTmpOption);
  ...
  pTmpOption->AddOption(L"Default"); pTmpOption->AddOption(L"True"); pTmpOption->AddOption(L"False"); pTmpOption->AllowEdit(FALSE);
  pGrpXmlFeatures->AddSubItem(pTmpOption); vTristateProperties.push_back(pTmpOption);
  pTmpOption = new CMFCPropertyGridProperty(L"Use inline schema", (xmltoolsoptions.useInlineSchema > 0 ? L"True" : (xmltoolsoptions.useInlineSchema == 0 ? L"False" : L"Default")), L"Specifies whether inline schemas should be processed (true) or not (false). When this property is set to true, inline schemas are used for validation. When this property is set to false, inline schemas are treated like any other XML fragments.\r\nThis property is supported in MSXML 6.0, and the default value is false.\r\nFor more information, see MSXML Security Overview (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms754611%28v%3dvs.85%29) and DOM Security (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms761392%28v%3dvs.85%29).", (DWORD_PTR)&xmltoolsoptions.useInlineSchema);
  pTmpOption->AddOption(L"Default"); pTmpOption->AddOption(L"True"); pTmpOption->AddOption(L"False"); pTmpOption->AllowEdit(FALSE);
  pGrpXmlFeatures->AddSubItem(pTmpOption); vTristateProperties.push_back(pTmpOption);
  pTmpOption = new CMFCPropertyGridProperty(L"Validate on parse", (xmltoolsoptions.validateOnParse > 0 ? L"True" : (xmltoolsoptions.validateOnParse == 0 ? L"False" : L"Default")), L"This property is used to specify whether the XML parser should validate (true) this document against document type definition (DTD), schema, or schema cache on loading.\r\nThis property is supported in MSXML 6.0 and the default value is true.\r\nFor more information, see MSXML Security Overview (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms754611%28v%3dvs.85%29) and DOM Security (https://docs.microsoft.com/en-us/previous-versions/windows/desktop/ms761392%28v%3dvs.85%29).", (DWORD_PTR)&xmltoolsoptions.validateOnParse);
  pTmpOption->AddOption(L"Default"); pTmpOption->AddOption(L"True"); pTmpOption->AddOption(L"False"); pTmpOption->AllowEdit(FALSE);
  pGrpXmlFeatures->AddSubItem(pTmpOption); vTristateProperties.push_back(pTmpOption);
